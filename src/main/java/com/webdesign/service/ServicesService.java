...
public class ServicesService {
	...
	public String addNewService(String title, String description, String url) {
		Services service = new Services(url, title, description);
	...
	public ServicesContext loadSpecificContext() {
